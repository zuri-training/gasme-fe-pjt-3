      ...
      {secured ? (
        <div className="s-board">
          <div
            ...
            style={{ transform: `translatex(${show})` }}
          >
            ...
            <div className="filter-body">
              <div className="ratings" style={{ marginTop: "20px" }}>
                ...
                <div className="stars">
                  ...
                  <label htmlFor="completed">Completed Request</label>
                </div>
                <div className="stars">
                ...
                <div className="pending">
                  ...
                  <label htmlFor="pending">Pending Request</label>
                </div>
                <div className="stars">
                  <input id="close" type="checkbox" value="close" />
                  <label htmlFor="close">Close-by Request</label>
                </div>
              </div>
        ...
        <Redirect to={{ pathname: "/gasme-fe-pjt-3/login/seller" }} />
      )}
    </>
  );
}
